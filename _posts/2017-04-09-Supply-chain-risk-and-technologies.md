...
The blockchain is an open distributed ledger. Peer-to-peer database maintains accurate transaction records autonomously. The technology is a core component of [bitcoin]() (digital currency). 
